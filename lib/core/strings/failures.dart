...
const String USER_NOT_FOUND_FAILURE_MESSAGE = 'User Not Found Failure';
...
const String NOT_FOUND_FAILURE_MESSAGE = 'Not Found';
const String NO_JOBS_POSTED_YET_FAILURE_MESSAGE = 'No Jobs Posted Yet';
const String NO_FAVORITE_JOBS_FAILURE_MESSAGE = 'No favorite jobs';
const String NO_SUBMITTED_JOBS_FAILURE_MESSAGE = 'No submitted jobs';
const String NO_ACTIVE_JOBS_FAILURE_MESSAGE = 'No active jobs';
